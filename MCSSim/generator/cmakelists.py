...
__CHEETAH_genTime__ = 1586513964.989269
__CHEETAH_genTimestamp__ = 'Fri Apr 10 13:19:24 2020'
__CHEETAH_src__ = 'cmakelists.tmpl'
...
''')
        for a in VFFSL(SL,"nta",True): # generated from line 7, col 1
            ...
            if _v is not None: write(_filter(_v, rawExpr=u'${a.name}')) # from line 8, col 2.
            write(u'''.cpp
''')
        write(u'''\tcommon.cpp
)
...
if not hasattr(cmakelists, '_initCheetahAttributes'):
    templateAPIClass = getattr(cmakelists,
