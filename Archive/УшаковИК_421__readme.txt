В архиве находится системы моделирования поведения системы интегрированной модульной авионики с использованием механизмов обеспечения отказоустойчивости.

Для запуска системы моделирования необходимо: 

1) Склонировать систему моделирования А.Б. Глониной в ту же папку, в которой лежат исходники программы используя команду git clone https://github.com/AlevtinaGlonina/MCSSim.
